...
[NOTE: Torivumab is a fictional investigational product created for simulation purposes. No clinical pharmacokinetic (PK), pharmacodynamic (PD), or prior Phase 1/2 efficacy data exist. All efficacy assumptions in this document are benchmarked against pembrolizumab KEYNOTE-024 trial data, which established clinical proof-of-concept for PD-1/PD-L1 blockade in first-line PD-L1 TPS ≥50% NSCLC. LG must insert or create fictional Phase 1/2 data to justify first-in-human to Phase 3 progression if this document is used in a regulatory simulation.]
...
(up to 28 days)          (up to 35 cycles / ~2 years)
                                                           Until death or
Eligible Patients  ──────────►  TORIVUMAB 200mg IV Q3W   ──────► study end
(PD-L1 TPS ≥50%)      2:1
NSCLC Stage         Rand.   ──────────►  PLACEBO IV Q3W        ──────►
IIIB/IIIC/IV
No EGFR/ALK                                                Long-Term
                                                           Follow-Up (LTFU):
                                                           every 12 weeks
                                                           for survival
```
