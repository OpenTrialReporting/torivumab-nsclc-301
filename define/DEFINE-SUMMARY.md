...
| CM | INTERVENTIONS | 2,319 | 17 | One record per subject per medication per occurrence |
...
| TR | FINDINGS | 6,136 | 21 | One record per subject per lesion per measurement per visit |
...
| ADCM | OCCURRENCE DATA STRUCTURE | 2,319 | 30 | One record per subject per concomitant medication occurrence |
