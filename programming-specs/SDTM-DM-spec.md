...
- [ ] `count(ARM)`: 300 "Torivumab + Chemotherapy", 150 "Placebo + Chemotherapy" — the raw generator (`programs/raw/01_demographics.R`) allocates 2:1 per protocol since 2026-09-20 (#27 D15; 225/225 before that)
