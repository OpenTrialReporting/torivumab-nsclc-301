...
DOMAIN_META <- list(
  ...
  dv     = list(class = "EVENTS",          structure = "One record per subject per protocol deviation",
                purpose = "Tabulation",
  ...
  advs   = list(class = "BASIC DATA STRUCTURE",
                structure = "One record per subject per vital-sign parameter per analysis timepoint",
                purpose = "Analysis",
                keys = c("STUDYID", "USUBJID", "PARAMCD", "AVISITN", "ADT")),
...
DOMAIN_LABEL <- c(
  ...
  dd = "Death Details", su = "Substance Use", dv = "Protocol Deviations",
