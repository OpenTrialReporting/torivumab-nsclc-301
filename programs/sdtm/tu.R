...
raw <- raw |>
  mutate(
    ...
    # Map to CDISC 'Anatomical Location' codelist submission values (P21 CT2002)
    TULOC    = dplyr::recode(str_to_upper(str_trim(ANATOMICAL_LOCATION)),
                 "BONE - PELVIS"                = "PELVIC BONE",
                 "BONE - RIB"                   = "RIB",
                 "BONE - VERTEBRA"              = "VERTEBRA",
                 "LEFT LUNG"                    = "LUNG",
                 "RIGHT LUNG"                   = "LUNG",
                 "LEFT LOWER LOBE"              = "LUNG, LEFT LOWER LOBE",
                 "RIGHT LOWER LOBE"             = "LUNG, RIGHT LOWER LOBE",
                 "RIGHT UPPER LOBE"             = "LUNG, RIGHT UPPER LOBE",
                 "LYMPH NODE - AXILLARY"        = "AXILLARY LYMPH NODE",
                 "LYMPH NODE - HILAR"           = "HILAR LYMPH NODE",
