...
|---|---|---|---|
| D1 | **Align to the M11 protocol** — E1/E2 origin `RANDDT` with `+ 1`, `AVALU = "MONTHS"`; E1b retains `TRTSDT`. Rationale of record: M11 §3 endpoint definition (`C25212`, "time from randomisation", cited to protocol §6), not the SAP | Lovemore Gakava | 2026-09-20 |
...
| D4, D7 | **Derive `EFFFL`** in ADSL/ADRS and point E3 at it; the current inline rule becomes the flag's specification | Lovemore Gakava | 2026-09-20 |
